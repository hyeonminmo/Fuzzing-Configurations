...
0-1. use ubuntu 20.04 LTS

0-2. <target> is the binary excutable of the target program compiled normally.

0-3. <fuzz_target> is the binary executable of the target program compiled by afl with persistent mode.
